...
// 			<DialogTitle id="activity-details-title">{act.name} details</DialogTitle>
// 			<Typography>act.tagLine</Typography>
// 			<Typography>act.descr</Typography>
// 		</Dialog>
// 	);
// }
...
function EventOrganising(props) {
	...
	// 									return <Row key={activity.id} row={activity} />;
	// 								})}
	// 							</TableBody>
	// 						</Table>
	// 					</TableContainer>
